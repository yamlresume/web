...
列出所有可用语言。语言代码遵循 [ISO 639 规范](https://www.iso.org/iso-639-language-code) 中的规范。您可以在 `locale.language` 中指定语言代码以更改简历的语言。更改简历的语言将自动翻译所有固定术语。您可以在我们的 [内容 -> 多语言](/zh-cn/docs/content/multi-languages) 章节查看更多详细信息。
