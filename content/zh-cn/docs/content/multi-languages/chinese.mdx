...
![汉字](/static/images/docs/content/multi-languages/chinese/Chenzihmyon_typefaces.svg.png)
...
地址格式在[英文](/content/multi-languages/english#location)和中文约定之间有所不同。与英文不同，在中文中呈现包含地址、城市和国家的地址时，一般部分（国家、州等）通常在前，而最具体的部分（城镇、地址等）在后。
