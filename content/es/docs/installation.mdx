...
Se requiere Node.js 22.x o posterior.

<Callout title="¿Por qué Node.js 22.x o posterior?">
  Los paquetes de YAMLResume declaran Node.js 22 como la versión mínima
  compatible. Las versiones anteriores de Node.js no son compatibles.
</Callout>
...
<Tab value="Ubuntu">
Usa el repositorio de Node.js 22 de
[NodeSource](https://github.com/nodesource/distributions) en lugar del paquete
`nodejs` de Ubuntu, cuya versión depende de la distribución:
...
<Tab value="RHEL">
Para Linux basado en RHEL como Fedora, AlmaLinux y Rocky Linux, usa el
repositorio de Node.js 22 de
...
```
MacTeX es una distribución grande, por lo que puede tomar algo de tiempo descargar e instalar y ocupa alrededor de 5GB de espacio en disco. Si deseas una distribución más pequeña, puedes instalar **BasicTeX**, que es una versión mínima de MacTeX:

```sh
brew install --cask basictex
```

Después de instalar BasicTeX, es posible que necesites instalar paquetes adicionales manualmente usando el comando `tlmgr`:
...
Puedes consultar el blog de Kostiantyn Lysenko, [YAMLResume - Resume as Code](https://lysenko.dev/posts/2025-01-yamlresume-resume-as-code/) para más detalles sobre basictex con YAMLResume.
