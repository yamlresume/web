...
La opción `page` le permite personalizar la configuración de la página, como el tamaño del papel, los márgenes y si mostrar los números de página.

La opción `margins` le permite personalizar los márgenes de la página. Ahora es parte del objeto `page` bajo `layouts`.
