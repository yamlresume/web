...
código de idioma en `layout.locale.language` para cambiar el idioma de tu
...
multi languages](/docs/content/multi-languages).
...
currículum configurando `layout.template` en tu currículum YAML. [PPResume
