...
de tu currículum: [alias de secciones](/docs/layout/sections/aliases) y
[reordenamiento de secciones](/docs/layout/sections/reorder). Estas
...
`work`) se [traducen](/docs/layout/sections/docs/content/multi-languages)
automáticamente según tu [idioma local](/docs/layout#locale) elegido. Sin
...
estándar](/docs/layout/sections/reorder#default-section-order). La
...
idiomas](/docs/layout/sections/reorder#default-section-order) por tu cuenta. Por
