...
v0.5](https://github.com/yamlresume/yamlresume/releases/tag/v0.5.0), un hito
...
v0.5](https://github.com/yamlresume/yamlresume/releases/tag/v0.5.0) introduce
...
Con [YAMLResume
v0.5](https://github.com/yamlresume/yamlresume/releases/tag/v0.5.0), puedes:
