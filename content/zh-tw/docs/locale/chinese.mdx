...
![漢字](/static/images/docs/locale/chinese/Chenzihmyon_typefaces.svg.png)
...
地址格式在[英文](/zh-tw/docs/locale/english#location)和中文慣例之間有所不同。與英文不同，在中文中呈現包含地址、城市和國家的地址時，一般部分（國家、省等）通常在前，而最具體的部分（城鎮、地址等）在後。
