...
列出所有可用語言。語言代碼遵循 [ISO 639 規範](https://www.iso.org/iso-639-language-code) 中的規範。您可以在 `locale.language` 中指定語言代碼以更改履歷的語言。更改履歷的語言將自動翻譯所有固定術語。您可以在我們的 [內容 -> 多語言](/zh-tw/docs/content/multi-languages) 章节查看更多詳細資訊。
