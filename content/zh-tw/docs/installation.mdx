...
理論上 `yamlresume` 應該可以與 Node.js 18 一起工作，但是強烈建議使用 Node.js 20 或更新版本，因為 Node.js 18 LTS 計劃在 [2025 年 4 月 30 日](https://nodejs.org/en/blog/release/v18.20.8) 到達生命週期結束。
</Callout>
...
<Callout title="為什麼選擇 LaTeX？">
  ...
  之前我寫了一篇文章[關於排版引擎](https://blog.ppresume.com/posts/on-typesetting-engines)，解釋了我在創立 [PPResume](https://ppresume.com) 時為什麼選擇 LaTeX 而不是其他排版引擎的原因。
</Callout>
...
<Tab value="Windows">
從網站下載最新版本的 [Linux Libertine](https://www.dafont.com/linux-libertine.font) 並解壓縮檔案並安裝字型。
</Tab>
