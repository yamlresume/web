...
YAMLResume 中的預設章節標題（例如，`education`、`work`）會根據您選擇的[區域語言](/zh-tw/docs/layouts#locale)自動[翻譯](/zh-tw/docs/layouts/sections/docs/content/multi-languages)。但是，您可能更喜歡不同的標題。例如，您可能希望將"工作"更改為"專業經驗"。
