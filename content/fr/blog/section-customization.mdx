...
structure de votre CV : [alias de sections](/docs/layout/sections/aliases) et [réordonnancement de
sections](/docs/layout/sections/reorder). Ces fonctionnalités vous permettent de renommer
...
automatiquement [traduits](/docs/layout/sections/docs/content/multi-languages)
basés sur votre [langue de locale](/docs/layout#locale) choisie. Cependant, vous pourriez
...
standard](/docs/layout/sections/reorder#default-section-order). La
...
de langues](/docs/layout/sections/reorder#default-section-order) par vous-même. Par
