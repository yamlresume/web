...
le [guide d'installation](/docs/getting-started#installation) pour l'installer.
...
multi langues](/docs/content/multi-languages).
...
définissant `layout.template` dans votre CV YAML. [Modèles PPResume](https://docs.ppresume.com/typesetting/templates) pour plus de détails.
