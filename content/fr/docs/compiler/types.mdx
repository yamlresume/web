...
| Prop          | Type                                                | Requis | Description                                                                      |
| ------------- | --------------------------------------------------- | ------ | -------------------------------------------------------------------------------- |
| `locale?`     | [`ResumeLayoutLocale`](#resumelayoutlocale)         | ⬜     | Définit les paramètres de locale pour l'internationalisation et la localisation. |
| `margins?`    | [`ResumeLayoutMargins`](#resumelayoutmargins)       | ⬜     | Définit les paramètres de marges de page pour la mise en page du document.      |
| `page?`       | [`ResumeLayoutPage`](#resumelayoutpage)             | ⬜     | Définit les paramètres au niveau de la page pour la présentation du document.   |
| `template?`   | [`Template`](#template)                             | ⬜     | Définit le modèle sélectionné.                                                  |
| `typography?` | [`ResumeLayoutTypography`](#resumelayouttypography) | ⬜     | Définit les paramètres typographiques pour le formatage du document.            |
| `latex?`      | [`ResumeLayoutLaTeX`](#resumelayoutlatex)           | ⬜     | Définit les options de configuration spécifiques à LaTeX.                       |
...
Voir aussi : [modèles](/fr/docs/layout/templates)
...
Voir aussi : [multi-langues](/fr/docs/content/multi-languages)
