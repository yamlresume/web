...
| Prop        | Type                            | Requis | Règles de Validation                                                             |
| ----------- | ------------------------------- | ------ | -------------------------------------------------------------------------------- |
| `fontspec?` | `{ numbers?: FontspecNumbers }` | ⬜     | Doit être parmi les [options de nombres fontspec](#fontspecnumbers) prédéfinies |
...
- Voir aussi : [templates](https://yamlresume.dev/docs/layouts/latex/templates)
...
- Voir aussi : [multi-languages](https://yamlresume.dev/docs/content/multi-languages)
