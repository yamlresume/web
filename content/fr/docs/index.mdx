...
YAMLResume a besoin d'un [moteur de composition](/fr/docs/getting-started#typesetting-engine) pour générer le PDF. Actuellement, il prend en charge deux moteurs de composition :

- [XeTeX](/fr/docs/getting-started#xetex)
- [Tectonic](/fr/docs/getting-started#tectonic)
...
Nous recommandons également d'installer la [police Linux Libertine](/fr/docs/getting-started#linux-libertine) pour la meilleure sortie PDF, mais c'est optionnel.
