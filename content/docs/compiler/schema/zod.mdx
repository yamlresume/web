...
| Prop        | Type                                                                                         | Required | Validation Rules                |
| ----------- | -------------------------------------------------------------------------------------------- | -------- | ------------------------------- |
| `layouts[]` | [`LatexLayoutSchema`](#latexlayoutschema) \| [`MarkdownLayoutSchema`](#markdownlayoutschema) | ⬜       | Array of layout configurations. |
...
- See also: [multi-languages](/docs/content/multi-languages)
