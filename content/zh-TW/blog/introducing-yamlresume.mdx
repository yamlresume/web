...
![YAMLResume 新建和建構履歷](../../blog/static/images/introducing-yamlresume/yamlresume-new-and-build.webp)
...
![履歷第 1 頁](../../blog/static/images/introducing-yamlresume/resume-1.webp)
![履歷第 2 頁](../../blog/static/images/introducing-yamlresume/resume-2.webp)
...
雖然我們決定不使用 markdown 作為履歷輸入格式，但我們確實支援各個部分中 `summary` 欄位的有限 markdown 富文字語法集。
...
content:
  basics:
    # ...
    summary: |
      這是一個支援有限 markdown 富文字語法集（粗體、斜體、連結、列表）的示例 YAML 履歷：

      - 電腦科學專業，在資料結構、**演算法**和軟體開發方面有*堅實基礎*
        1. 像素完美的全端網頁開發者，專門創建高品質、視覺吸引力的網站
        2. 在資料庫（SQL、NoSQL）方面有經驗，熟悉伺服器端技術（[Node.js](https://nodejs.org/en)、Express 等）
      - 團隊合作者，具有注重細節的思維和對設計和使用者體驗的敏銳眼光
```

這是生成的 PDF：

![摘要欄位中的富文字支援](../../blog/static/images/introducing-yamlresume/rich-text-support-in-summary-field.webp)
