...
![Dev Mode Workflow](./static/images/dev-mode/dev-mode-vs-code.webp)
...
Now, you can open your `my-resume.yml` file and your PDF side-by-side. Every time
you save a change to your YAML file, YAMLResume will automatically detect it and
trigger a rebuild. Your PDF viewer will update moments later, showing you the
