...
<Cards>
  <Card
    title="English"
    href="/ja/content/multi-languages/english"
    description="新しい履歴書を作成する際、英語は YAMLResume のデフォルト言語です。"
  />
  <Card
    title="Chinese"
    href="/ja/content/multi-languages/chinese"
    description="簡体字中国語と繁体字中国語（香港と台湾）をサポートしています。"
  />
  <Card
    title="Norwegian"
    href="/ja/content/multi-languages/norwegian"
    description="ノルウェー語は主にノルウェーで使用される北ゲルマン語です。"
  />
  <Card
    title="Spanish"
    href="/ja/content/multi-languages/spanish"
