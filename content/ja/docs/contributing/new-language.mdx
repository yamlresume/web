...
YAMLResume は[多言語](/zh-cn/docs/content/multi-languages)を基盤からサポートするように設計されており、ユーザーが好みの言語で履歴書を作成できるようになっています。

この記事の執筆時点で、YAMLResume は以下の言語をサポートしています：

- [英語](/zh-cn/docs/content/multi-languages/english)
- [中国語](/zh-cn/docs/content/multi-languages/chinese)
- [ノルウェー語](/zh-cn/docs/content/multi-languages/norwegian)
- [スペイン語](/zh-cn/docs/content/multi-languages/spanish)
...
YAMLResume に新しい `layout.locale.language` オプションを追加するには、まず [models/resume.ts](https://github.com/yamlresume/yamlresume/blob/main/packages/core/src/models/resume.ts) で言語を登録し、`LOCALE_LANGUAGE_OPTIONS` に新しいエントリを追加します。
...
- [ ] `layout.locale.language` を追加した新しい言語に設定
