...
Jepang (日本語) adalah bahasa Asia Timur yang terutama dituturkan di Jepang. Ini adalah
anggota dari keluarga bahasa Japonic.

## Linguistik

### Set Karakter

Sistem penulisan Jepang menggunakan kombinasi dari tiga aksara: Kanji (karakter
Tionghoa yang diadopsi), Hiragana, dan Katakana. Aksara Latin (Romaji) juga digunakan
untuk tujuan tertentu.

### Dukungan CJK

YAMLResume secara otomatis mendeteksi bahasa Jepang sebagai bahasa CJK dan menerapkan
penyesuaian tata letak spesifik, seperti menggunakan angka bergaya "Lining" alih-alih "OldStyle"
untuk mencocokkan glyph CJK dengan lebih baik.

## Idiom

### Tanggal

Tanggal Jepang diformat dengan urutan Tahun, Bulan, dan Hari, menggunakan penghitung spesifik.
...
Rentang tanggal menggunakan tilde lebar penuh (U+FF5E) sebagai pemisah (misalnya 2016年10月～
2018年1月).

### Lokasi

Dalam resume yang dihasilkan, alamat Jepang umumnya mengikuti urutan
Negara, Wilayah (Prefektur), Kota, Alamat, dan akhirnya Kode Pos.

Catatan: Meskipun alamat Jepang standar biasanya dimulai dengan Kode Pos (〒),
YAMLResume saat ini menambahkannya di akhir untuk konsistensi dengan variabel
...
Jepang menggunakan tanda baca lebar penuh.

- **Koma**: `、` (Koma Ideografis, U+3001) digunakan alih-alih koma Latin
  `,`.
- **Titik dua**: `：` (Titik dua Lebar Penuh, U+FF1A) digunakan alih-alih titik dua Latin
  `:`.
- **Pemisah**: `、` juga digunakan sebagai pemisah daftar.

## Terjemahan

YAMLResume mengadopsi terjemahan berikut untuk berbagai opsi dan istilah yang digunakan
dalam resume bahasa Jepang.
...
| Rwanda                               | ルワンダ                                   |
| Saint Helena                         | セントヘレナ                               |
| Saint Kitts And Nevis                | セントクリストファー・ネイ비스             |
| Saint Lucia                          | セントルシア                               |
